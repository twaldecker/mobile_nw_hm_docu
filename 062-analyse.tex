...
\subsubsection{Abis over IP tracen mit Wireshark}
...
Das Abis over IP Protokoll wird nicht von Wireshark unterstützt und aufgelöst. Dieses Feature steht aber als Patch für Wireshark vom OpenBSC Projekt zur Verfügung. 

{\Large TODO kompilieren von wireshark }
