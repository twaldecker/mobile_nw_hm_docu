...
Der Inhalt eines solchen Pakets ist in Listing \ref{lst:measurement-result} abgedruckt. Die \gls{bts} leitet dieses Paket an die \gls{bsc} weiter, die die Entscheidung über einen Handover trifft.
